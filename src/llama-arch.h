...
enum llm_tensor {
    ...
    LLM_TENSOR_G4V_LN1,
    LLM_TENSOR_G4V_LN2,
    LLM_TENSOR_VISION_TOKEN_EMBD,
    LLM_TENSOR_VISION_OUTPUT_NORM,
    LLM_TENSOR_VISION_PROJ_IN,
    LLM_TENSOR_VISION_PROJ_OUT,
    LLM_TENSOR_VISION_POS_EMBD,
    LLM_TENSOR_VISION_CLASS_EMBD,
    LLM_TENSOR_G4_LAYER_OUTPUT_SCALE,
    LLM_TENSOR_G4_POST_ATTN_NORM,
    LLM_TENSOR_G4_POST_FFW_NORM,
