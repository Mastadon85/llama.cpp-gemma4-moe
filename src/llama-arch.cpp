...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_VISION_BLOCK_COUNT,                "gemma4.vision.block_count"            },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_POST_NORM,                         "blk.%d.attn_post_norm" },
    ...
    { LLM_TENSOR_G4V_ATTN_Q,                             "v.blk.%d.attn_q" },
    { LLM_TENSOR_G4V_ATTN_K,                             "v.blk.%d.attn_k" },
    { LLM_TENSOR_G4V_ATTN_V,                             "v.blk.%d.attn_v" },
    { LLM_TENSOR_G4V_ATTN_OUT,                           "v.blk.%d.attn_out" },
    { LLM_TENSOR_G4V_ATTN_Q_NORM,                        "v.blk.%d.attn_q_norm" },
    { LLM_TENSOR_G4V_ATTN_K_NORM,                        "v.blk.%d.attn_k_norm" },
    { LLM_TENSOR_G4V_ATTN_NORM,                          "v.blk.%d.ffn_post_norm" },
    { LLM_TENSOR_G4V_ATTN_POST_NORM,                     "v.blk.%d.attn_post_norm" },
    { LLM_TENSOR_G4V_FFN_GATE,                           "v.blk.%d.ffn_gate" },
    { LLM_TENSOR_G4V_FFN_UP,                             "v.blk.%d.ffn_up" },
    { LLM_TENSOR_G4V_FFN_DOWN,                           "v.blk.%d.ffn_down" },
    { LLM_TENSOR_G4V_LN1,                                "v.blk.%d.ln1" },
    { LLM_TENSOR_G4V_LN2,                                "v.blk.%d.ln2" },
    { LLM_TENSOR_VISION_TOKEN_EMBD,                     "%s.vision.token_embd" },
    { LLM_TENSOR_VISION_OUTPUT_NORM,                    "%s.vision.output_norm" },
    { LLM_TENSOR_VISION_PROJ_IN,                        "%s.vision.proj_in" },
    { LLM_TENSOR_VISION_PROJ_OUT,                       "%s.vision.proj_out" },
    { LLM_TENSOR_VISION_POS_EMBD,                       "%s.vision.pos_embd" },
    { LLM_TENSOR_VISION_CLASS_EMBD,                     "%s.vision.class_embd" },
    { LLM_TENSOR_G4_LAYER_OUTPUT_SCALE,                    "blk.%d.layer_output_scale" },
    { LLM_TENSOR_G4_POST_ATTN_NORM,                        "blk.%d.post_attention_norm" },
    { LLM_TENSOR_G4_POST_FFW_NORM_1,                       "blk.%d.post_ffw_norm_1" },
    { LLM_TENSOR_G4_POST_FFW_NORM_2,                       "blk.%d.post_ffw_norm_2" },
    { LLM_TENSOR_G4_PRE_FFW_NORM_2,                        "blk.%d.pre_ffw_norm_2" },
    { LLM_TENSOR_G4_FFN_DOWN_EXPS_SCALE,                   "blk.%d.ffn_down_exps.scale" },
    { LLM_TENSOR_G4_FFN_GATE_INP_SCALE,                    "blk.%d.ffn_gate_inp.scale" },
    { LLM_TENSOR_G4_MM_INPUT_PROJ,                      "mm.input_projection" },
    { LLM_TENSOR_G4V_PATCH_EMBD,                        "v.patch_embd" },
    { LLM_TENSOR_G4V_POS_EMBD,                          "v.position_embd" },
    { LLM_TENSOR_G4V_STD_BIAS,                          "v.std_bias" },
    { LLM_TENSOR_G4V_STD_SCALE,                         "v.std_scale" },
};
    ...
    switch (arch) {
        ...
        case LLM_ARCH_GEMMA4:
            return {
                ...
                LLM_TENSOR_FFN_GATE_UP_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_G4_POST_ATTN_NORM,
                LLM_TENSOR_G4_POST_FFW_NORM_1,
                LLM_TENSOR_G4_POST_FFW_NORM_2,
                LLM_TENSOR_G4_PRE_FFW_NORM_2,
                LLM_TENSOR_G4_FFN_DOWN_EXPS_SCALE,
                LLM_TENSOR_G4_FFN_GATE_INP_SCALE,
                LLM_TENSOR_G4_LAYER_OUTPUT_SCALE,
                LLM_TENSOR_G4V_ATTN_Q,
                LLM_TENSOR_G4V_ATTN_K,
                LLM_TENSOR_G4V_ATTN_V,
                LLM_TENSOR_G4V_ATTN_OUT,
                LLM_TENSOR_G4V_ATTN_Q_NORM,
                LLM_TENSOR_G4V_ATTN_K_NORM,
                LLM_TENSOR_G4V_ATTN_NORM,
                LLM_TENSOR_G4V_ATTN_POST_NORM,
                LLM_TENSOR_G4V_FFN_GATE,
                LLM_TENSOR_G4V_FFN_UP,
                LLM_TENSOR_G4V_FFN_DOWN,
                LLM_TENSOR_G4V_LN1,
                LLM_TENSOR_G4V_LN2,
                LLM_TENSOR_G4_MM_INPUT_PROJ,
                LLM_TENSOR_G4V_PATCH_EMBD,
                LLM_TENSOR_G4V_POS_EMBD,
                LLM_TENSOR_G4V_STD_BIAS,
                LLM_TENSOR_G4V_STD_SCALE,
            };
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ROPE_FREQS,                 {LLM_TENSOR_LAYER_INPUT,  GGML_OP_ROPE}},
    ...
    {LLM_TENSOR_G4V_ATTN_Q,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_K,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_V,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_OUT,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_Q_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_K_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_ATTN_POST_NORM,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_FFN_GATE,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_FFN_UP,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_FFN_DOWN,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_LN1,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4V_LN2,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_VISION_TOKEN_EMBD,          {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_VISION_OUTPUT_NORM,         {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_NONE}},
    {LLM_TENSOR_VISION_PROJ_IN,             {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_VISION_PROJ_OUT,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_NONE}},
    {LLM_TENSOR_VISION_POS_EMBD,            {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_VISION_CLASS_EMBD,          {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_G4_LAYER_OUTPUT_SCALE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_POST_ATTN_NORM,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_POST_FFW_NORM_1,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_POST_FFW_NORM_2,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_PRE_FFW_NORM_2,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_FFN_DOWN_EXPS_SCALE,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_FFN_GATE_INP_SCALE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_G4_MM_INPUT_PROJ,              {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_G4V_PATCH_EMBD,                {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_G4V_POS_EMBD,                  {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_G4V_STD_BIAS,                  {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_G4V_STD_SCALE,                 {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
};
